...
class QDialogSplash(QDialog):
   def __init__(self, *args, **kwargs):
       ...
       self.model_label = QLabel("Training Model:\nSelect the machine learning training model.")
       self.model_desc = QLabel("Training Model:")
       self.model.addItems(TRAINING_MODELS)
       self.model.setStyleSheet("QListWidget {background: white; font-family: Verdana; font-style: normal; font-size: 11pt}")
       self.model.setFont(self.combo_box_font)
       self.model.setCurrentText(TRAINING_MODELS[TRAINING_NUM])
       scroll_layout.addWidget(self.model_label,5,0, 1, 2)
       scroll_layout.addWidget(self.model_desc,6,0)
       scroll_layout.addWidget(self.model,6,1)
       ...
       scroll_layout.addWidget(self.instances_desc, 9, 0, 1, 2)
       scroll_layout.addWidget(self.instances_label, 10, 0)
       scroll_layout.addWidget(self.instances_box, 10, 1)
       scroll_layout.addWidget(QHLine(), 11, 0, 1, 2)
       ...
       scroll_layout.addWidget(self.channels_box, 13, 1)
       scroll_layout.addWidget(self.channels_desc, 12, 0, 1, 2)
       scroll_layout.addWidget(self.channels_label, 13, 0)
       scroll_layout.addWidget(QHLine(), 14, 0, 1, 2)
       ...
       scroll_layout.addWidget(self.frame_desc, 15, 0, 1, 2)
       scroll_layout.addWidget(self.frame_box, 16, 1)
       scroll_layout.addWidget(self.frame_label, 16, 0)
       scroll_layout.addWidget(QHLine(), 17, 0, 1, 2)
       ...
       scroll_layout.addWidget(self.ds_mic_label, 21, 0)
       scroll_layout.addWidget(self.ds_mic, 21, 1)
       ...
       scroll_layout.addWidget(self.record_label, 22, 0)
       scroll_layout.addWidget(self.record_box, 22, 1)
       scroll_layout.addWidget(self.overlap_label, 23, 0)
       scroll_layout.addWidget(self.overlap_box, 23, 1)
       ...
       scroll_layout.addWidget(self.ds_label,18,0, 1, 2)
       scroll_layout.addWidget(self.ds_desc,19,0)
       scroll_layout.addWidget(self.ds,19,1)
       scroll_layout.addWidget(self.sr_label,20,0)
       scroll_layout.addWidget(self.sr_box,20,1)
       scroll_layout.addWidget(QHLine(), 24, 0, 1, 2)
       ...
       scroll_layout.addWidget(self.algo_desc,25,0,1 ,2)
       scroll_layout.addWidget(self.algo_label,26,0)
       scroll_layout.addWidget(self.algo,26,1)
       scroll_layout.addWidget(self.bins_box,27,1)
       scroll_layout.addWidget(self.bins_label,27,0)
