...
#chunks_per_second = int(RATE / FRAME_LENGTH)  # how many chunks per second
        ...
        if length>=FRAME_LENGTH:
            ...
            if is_collecting_dataset:
                if training_data_frame_counter<INSTANCES:
                    ...
                    #print("training_data 1:", training_data)
                if training_data_frame_counter == instances:
:
